...
AS
SELECT SD.MA_DK, SD.MA_CT, CT.TEN_CT,SD.MA_DV, DV.TEN_DV, SD.NGAY_BD, SD.NGAY_KT, DV.DON_GIA_CS, (CT.DIEN_TICH*300000) AS MAT_BANG,
CASE
...
# SELECT SD.MA_DK,SD.MA_CT,CT.TEN_CT,DV.TEN_DV,IF ('2020-09-15' > SD.NGAY_KT, SD.NGAY_KT, '2020-09-15') AS NGAY_BD, IF ('2020-09-17' > SD.NGAY_KT, SD.NGAY_KT, '2020-09-17') AS NGAY_KT, DV.DON_GIA_CS, (CT.DIEN_TICH*300000) AS MAT_BANG,
#     CASE
#     WHEN CT.SO_NV > 10 AND CT.DIEN_TICH > 100 THEN DATEDIFF(IF ('2020-09-17' > SD.NGAY_KT, SD.NGAY_KT, '2020-09-17'), IF ('2020-09-15' > SD.NGAY_KT, SD.NGAY_KT, '2020-09-15'))*DV.DON_GIA_CS*(1 + (FLOOR((CT.SO_NV - 10)/5) + FLOOR((CT.DIEN_TICH - 100)/10))*0.05)
#     WHEN CT.SO_NV > 10 THEN DATEDIFF(IF ('2020-09-17' > SD.NGAY_KT, SD.NGAY_KT, '2020-09-17'), IF ('2020-09-15' > SD.NGAY_KT, SD.NGAY_KT, '2020-09-15'))*DV.DON_GIA_CS*(1 + (FLOOR((CT.SO_NV - 10)/5))*0.05)
#     WHEN CT.DIEN_TICH > 100 THEN DATEDIFF(IF ('2020-09-17' > SD.NGAY_KT, SD.NGAY_KT, '2020-09-17'), IF ('2020-09-15' > SD.NGAY_KT, SD.NGAY_KT, '2020-09-15'))*DV.DON_GIA_CS*(1 + (FLOOR((CT.DIEN_TICH - 100)/10))*0.05)
#     ELSE DATEDIFF(IF ('2020-09-17' > SD.NGAY_KT, SD.NGAY_KT, '2020-09-17'), IF ('2020-09-15' > SD.NGAY_KT, SD.NGAY_KT, '2020-09-15'))*DV.DON_GIA_CS
#     END AS THUC_TRA
# FROM CONG_TY AS CT, dich_vu AS DV, SU_DUNG AS SD
# WHERE CT.MA_CT = SD.MA_CT
#   AND DV.MA_DV = SD.MA_DV
...
CREATE VIEW THONG_TIN_RA_VAO AS
    ...
    WHERE RV.MA_THE = TR.MA_THE AND TR.MA_NV = NV.MA_NV AND 
